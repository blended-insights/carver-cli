...
export interface IFileWatcher extends EventEmitter {
   ...
   * @param listener Event listener
   */
  off<E extends keyof FileWatcherEvents>(event: E, listener: FileWatcherEvents[E]): this;
   ...
   * @param listener Event listener
   */
  once<E extends keyof FileWatcherEvents>(event: E, listener: FileWatcherEvents[E]): this;
